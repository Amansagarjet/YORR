...
if (isset($_POST['submit']))
 {
    ...
    try{
        ...
        $qry = "INSERT INTO `users`(`Username`, `Contact`, `Address`, `Aadhar`, `Password`) 
            ...
            $qry = "INSERT INTO `partners`(`name`, `mobile`, `address`, `aadharcard`, `password`) 
                VALUES ('$username','$contact','$address','$aadhar','$hashpass')";
                $run = mysqli_query($con,$qry);
        }
        if($run==true)
            ...
            <div class="modal-dialog modal-dialog-centered">
                <div class="modal-content">
                    ...
                    <form role="form" action = "register.php" method="post"name="myForm" enctype="multipart/form-data" id="form" 
                        ...
                        <div class="form-group">
                            <label for="contact" class="text-danger">Mobile *</label>
                        ...
                        <div class="form-group">
                            <label for="aadhar" class="text-danger">Aadhar No</label>
                        ...
                        <div class="form-group" >
                        <label class="text-danger">Select One *</label>
                            <select name="choose" id="choose" class="form-control" reqiured readonly>
                        ...
                        <div class="modal-footer justify-content-center">
                            ...
                            <input type="submit" value="Create Account"  name="submit" class="btn btn-success alert rounded-pill btn-lg">
                        </div>
                    </form>
                </div>
            </div>
