            ...
            <div class="modal-dialog modal-dialog-centered">
                <div class="modal-content">
                    ...
                    <div class="container-fluid">
                        <form role="form" action="login.php" method="post" name="myForm" enctype="multipart/form-data" id="form" onsubmit="return validation()">
                            <div class="form-group">

                                <div class="form-group">
                                    <label for="contact" class="text-primary">Mobile Number *</label>
                                ...
                                <div class="form-group" class="text-primary">
                                    ...
                                    <input type="password" name="pass" id="pass1" class="form-control" minlength="1" onblur="passValidation()" placeholder="Enter password">
